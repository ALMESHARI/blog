...
// this will upload only one original image without resizing it
...
async function getImage(req, res) {
  try {
    let imageType = req.params.type; //this detemine the image size to be returned [original,medium,low]
...
export {uploadImage,getImage,uploadImageResolutions}